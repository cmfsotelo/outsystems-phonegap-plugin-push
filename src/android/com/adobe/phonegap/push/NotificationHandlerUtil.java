...
public final class NotificationHandlerUtil implements PushConstants {


    private static final String LOG_TAG = "Push_FCMService";
    private static HashMap<Integer, ArrayList<String>> messageMap = new HashMap<Integer, ArrayList<String>>();

    public static void setNotification(int notId, String message) {
    ...
    public static void handleMessage(Context context, Bundle message, boolean fromLaunchIntent) {
        ...
        message = normalizeExtras(context, message, messageKey, titleKey);
        ...
        if (!forceShow && PushPlugin.isInForeground()) {
            ...
            message.putBoolean(FOREGROUND, true);
            message.putBoolean(COLDSTART, false);
        ...
        // if we are in the foreground and forceShow is `true`, force show the notification if the data has at least a message or title
            ...
            showNotificationIfPossible(context, message);
        } else if (fromLaunchIntent) {
            Log.d(LOG_TAG, "from launch intent");
            message.putBoolean(FOREGROUND, false);
            message.putBoolean(COLDSTART, PushPlugin.isActive());
            PushPlugin.sendExtras(message);
        }
    ...
    */
    public static void replaceKey(Context context, String oldKey, String newKey, Bundle extras, Bundle newExtras) {
     ...
     */
    public static String localizeKey(Context context, String key, String value) {
     ...
     */
    public static Bundle normalizeExtras(Context context, Bundle extras, String messageKey, String titleKey) {
    ...
    private static int extractBadgeCount(Bundle extras) {
        int count = -1;
    ...
    private static void showNotificationIfPossible(Context context, Bundle extras) {
    ...
    private static void setNotificationVibration(Bundle extras, Boolean vibrateOption, NotificationCompat.Builder mBuilder) {
    ...
    private static void setNotificationSound(Context context, Bundle extras, NotificationCompat.Builder mBuilder) {
    ...
    private static void setNotificationLedColor(Bundle extras, NotificationCompat.Builder mBuilder) {
    ...
    private static void setNotificationPriority(Bundle extras, NotificationCompat.Builder mBuilder) {
    ...
    private static void setNotificationLargeIcon(Context context, Bundle extras, String packageName, Resources resources, NotificationCompat.Builder mBuilder) {
    ...
    private static void setNotificationIconColor(String color, NotificationCompat.Builder mBuilder, String localIconColor) {
        int iconColor = 0;
    ...
    private static void createActions(Context context, Bundle extras, NotificationCompat.Builder mBuilder, Resources resources, String packageName, int notId) {
    ...
    private static void updateIntent(Intent intent, String callback, Bundle extras, boolean foreground, int notId) {
    ...
    private static void setNotificationCount(Context context, Bundle extras, NotificationCompat.Builder mBuilder) {
